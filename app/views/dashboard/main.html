        ...
        <div class="row">
            ...
            <section class="col-lg-7 connectedSortable">
                ...
                <div class="box box-success">
                    ...
                    <div class="box-body reports" id="reports-box">
                        <!-- Reports item -->
                        <div class="item">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <b class="card-title clearfix">Available Reports</b>
                                ...
                                <div class="card-body text-center" id="reports-loading">
                                    <div class="spinner-border" role="status">
                                        <span class="sr-only">Loading...</span>
                                    </div>
                                </div>

                                <div class="card-body" id="reports-body" style="display: none;">

                                    <div class="row" id="report_tools_container" style="display: none;">
                                        <div class="col-md-12" id="report_tools">
                                        </div>
                                    </div>

                                    <table data-toggle="table" class="display table table-striped " id="report_list">
                                        <thead></thead>
                                        <tbody></tbody>
                                        <tfoot></tfoot>
                                        <caption style="caption-side: top;"
                                                 class="display-5 font-weight-bold"></caption>
                                    </table>
